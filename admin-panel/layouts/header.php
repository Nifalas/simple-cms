...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      <div class="container">
      <a class="navbar-brand" style="background-color:white;" href="#">LOGO</a>
...
<?php if(isset($_SESSION['adminname'])) : ?> 
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav side-nav" >
          ...
          <li class="nav-item">
            <a class="nav-link" href="http://localhost/PHP/CMS/admin-panel/users/users.php" style="margin-left: 20px;">Users</a>
          </li>
          <li class="nav-item">
