        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
             ...
             <a  href="http://localhost/PHP/CMS/admin-panel/categories-admins/create-category.php" class="btn btn-primary mb-4 text-center float-right">Create Categories</a>
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
