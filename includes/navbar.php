...
<body>
    <!-- Navigation-->
    <?php $site_url = 'http://localhost/PHP/CMS' ?>
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="<?php echo $site_url; ?>/index.php"> LOGO </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <?php if (isset($_SESSION['username'])) : ?>
                        ...
                        <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo $site_url; ?>/admin-panel/admins/login-admins.php">admin</a></li>
                    <?php else : ?>
                    ...
                    <li class="nav-item"><a class="nav-link px-lg-3 py-3 py-lg-4" href="<?php echo $site_url; ?>/contact.php">Contact</a></li>
                </ul>
            </div>
        </div>
    </nav>